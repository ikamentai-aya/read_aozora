...
#読む本を選ぶためのwidget
import_down = Dropdown(label="小説の選択", button_type="warning", menu=['ダウンロード済み', '新たにダウンロード'], width=200, background = 'blue')
...
forward_button = Button(label='▷', button_type='success', width=100, background='black')
...
def make_matrix_sub(center, initial_set):
    ...
    toolList = ['pan', 'box_zoom', 'tap', 'reset', 'save']
...
def show_range_renderer(attr, old, new):
    if initial_set==False:make_matrix_sub(False, False)
